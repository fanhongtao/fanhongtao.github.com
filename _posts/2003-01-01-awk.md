...
## 2.2 <a name="full_flow">完整的AWK流程</a>
...
* [BEGIN 和 END 模式](#Pattern.BeginEnd)


## 5.1 <a name="RegularExpression">正则表达式</a>
...
## 5.2 <a name="Relationalexpression">关系表达式</a>
...
## 5.3 <a name="Pattern.Component">模式的组合</a>
...
## 5.4 <a name="Pattern.BeginEnd">BEGIN 和 END 模式</a>
...
* [输出语句](#Action.OutputStatement)

## 8.1 <a name="Action.ConditionalStatement">条件语句</a>
...
## 8.2 <a name="Action.OutputStatement">输出语句</a>
AWK中提供了两种输出语句：
### 8.2.1. print
print 的语法格式为：
<pre>
